        ...
        <div className="flex flex-col ">
            <div className="flex flex-col pl-13">
                ...
                <div className="flex flex-wrap pr-13 pt-3 justify-between">
                    ...
                    <Button className="p-5 cursor-pointer bg-orange-500"><span className="">+ Novo Cliente</span></Button>
                </div>
            </div>
            <div>
                <div className="flex flex-wrap gap-4 p-13">
                        <Card className="w-80 h-70 background-sidebar border border-zinc-600 border-t-3 border-t-orange-500 cursor-pointer hover:border-orange-500 hover:text-orange-500 hover:border-2 hover:-translate-y-2">
                        <CardHeader className=' pb-4'>
                            <CardTitle className="flex justify-between ">
                                <div><b>Icone</b></div>
                                <div><a href="#clientes" className="hover:border-orange-500 hover:text-orange-500">24 pedidos</a></div>
                            </CardTitle>
                        </CardHeader>
